        ...
        <div className="flex gap-1 mb-5 bg-white/5 rounded-xl p-1">
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-sm font-semibold transition-colors ${
              tab === "global" ? "bg-primary text-white" : "text-white/50 hover:text-white"
            }`}
          >
          ...
          <button
            onClick={() => setTab("dm")}
            className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-sm font-semibold transition-colors ${
              tab === "dm" ? "bg-primary text-white" : "text-white/50 hover:text-white"
            }`}
          >
          ...
          <div className="flex flex-col gap-3">
            {globalLoading ? (
              ...
              <div className="glass-panel rounded-2xl p-8 text-center">
                <Globe className="w-10 h-10 mx-auto mb-3 text-white/20" />
                <p className="text-white/50 text-sm">Belum ada pesan. Jadilah yang pertama!</p>
              </div>
            ) : (
            ...
            <div className="flex items-center gap-2 mt-2">
              <input
                ...
                placeholder="Tulis pesan ke semua..."
