...
replace_once(
    ...
    'import { ArrowLeft, Heart, Bookmark, Download, Copy, Play, MessageCircle, Trash2, ExternalLink, CornerDownRight, X, Copyright } from "lucide-react";',
...
print("\nSelesai patch61: badge CR muncul di halaman video kalau video bukan buatan sendiri.")
